...
int main() {
    ...
    flags:
        ...
        - 0
    */
    VM_word result = VM_add(1, 1, &flags);
    ...
    flags:
        ...
        - 0
    */
    result = VM_add(0xFFFF, 1, &flags);
    if (result != 0) {return 51;}
    if (VM_getflag(flags, 0) != 1) {return 11;}
